...
static const char qt_meta_stringdata_LigneRoute[] = {
    "LigneRoute\0"
};
...
const QMetaObjectExtraData LigneRoute::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LigneRoute::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_LigneRoute,
      qt_meta_data_LigneRoute, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LigneRoute::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LigneRoute))
