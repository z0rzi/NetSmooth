...
static const char qt_meta_stringdata_VueInformationControleur[] = {
    "VueInformationControleur\0\0"
    "actionClickAllumer()\0rafraichir()\0"
    "rename()\0"
};
...
void VueInformationControleur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->actionClickAllumer(); break;
        case 1: _t->rafraichir(); break;
...
const QMetaObjectExtraData VueInformationControleur::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VueInformationControleur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VueInformationControleur,
      qt_meta_data_VueInformationControleur, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VueInformationControleur::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VueInformationControleur))
