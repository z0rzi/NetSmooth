...
static const char qt_meta_stringdata_VueRoutesControleur[] = {
    "VueRoutesControleur\0"
};
...
const QMetaObjectExtraData VueRoutesControleur::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VueRoutesControleur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VueRoutesControleur,
      qt_meta_data_VueRoutesControleur, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VueRoutesControleur::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VueRoutesControleur))
