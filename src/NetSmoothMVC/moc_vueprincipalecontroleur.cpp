...
static const char qt_meta_stringdata_VuePrincipaleControleur[] = {
    "VuePrincipaleControleur\0\0pos\0"
    "actionClickSouris(QPoint)\0"
};
...
const QMetaObjectExtraData VuePrincipaleControleur::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VuePrincipaleControleur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VuePrincipaleControleur,
      qt_meta_data_VuePrincipaleControleur, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VuePrincipaleControleur::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VuePrincipaleControleur))
