...
const QMetaObjectExtraData ClickLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ClickLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ClickLabel,
      qt_meta_data_ClickLabel, &staticMetaObjectExtraData }
};
