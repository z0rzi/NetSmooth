...
#include "../../../../Téléchargements/NetSmooth-6f401b440d83c6269525148e3a5eb2ce06c2a569/src/NetSmoothMVC/controleurs/vuehubcontroleur.h"
...
struct qt_meta_stringdata_VueHubControleur_t {
    QByteArrayData data[3];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_VueHubControleur_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VueHubControleur_t qt_meta_stringdata_VueHubControleur = {
    {
QT_MOC_LITERAL(0, 0, 16), // "VueHubControleur"
QT_MOC_LITERAL(1, 17, 7), // "allumer"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "VueHubControleur\0allumer\0"
};
...
const QMetaObject VueHubControleur::staticMetaObject = {
    { &VueEntiteeControleur::staticMetaObject, qt_meta_stringdata_VueHubControleur.data,
      qt_meta_data_VueHubControleur,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VueHubControleur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VueHubControleur.stringdata0))
