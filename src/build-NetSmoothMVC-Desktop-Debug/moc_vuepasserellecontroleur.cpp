...
#include "../NetSmoothMVC/vuepasserellecontroleur.h"
...
static const char qt_meta_stringdata_VuePasserelleControleur[] = {
    "VuePasserelleControleur\0\0allumer()\0"
};
...
const QMetaObjectExtraData VuePasserelleControleur::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VuePasserelleControleur::staticMetaObject = {
    { &VueEntiteeControleur::staticMetaObject, qt_meta_stringdata_VuePasserelleControleur,
      qt_meta_data_VuePasserelleControleur, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VuePasserelleControleur::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VuePasserelleControleur))
